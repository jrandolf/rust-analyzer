...
use hir_def::{
    hir::{
        ArithOp, Array, AsmOperand, AsmOptions, BinaryOp, ClosureKind, CoroutineDesugaring,
        CoroutineKind, Expr, ExprId, LabelId, Literal, Statement, UnaryOp,
    },
...
impl InferenceContext<'_> {
    ...
    pub(crate) fn lower_gen_block_type_impl_trait(&mut self, inner_ty: Ty, tgt_expr: ExprId) -> Ty {
        ...
        // existential type GenBlockImplTrait<InnerType>: Future<Output = InnerType>
    ...
    pub(crate) fn lower_async_gen_block_type_impl_trait(
        ...
        // Use the first type parameter as the output type of future.
        // existential type AsyncGenBlockImplTrait<InnerType>: Future<Output = InnerType>
